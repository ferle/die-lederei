...
import { Menu, X, ShoppingBag, Shield, Instagram, LogIn } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <header className="bg-white border-b border-stone-200">
        ...
        {/* Mobile Navigation */}
        {isMobileMenuOpen && (
          <nav className="md:hidden border-t border-stone-200">
            <div className="max-w-7xl mx-auto px-6 py-4 space-y-4">
              <Link
                to="/"
                className="block text-lg text-burgundy-800 hover:text-burgundy-600 transition"
              ...
              <div className="pt-4 border-t border-stone-200 flex items-center space-x-6">
                ...
                {user ? (
                  ...
                  <Link
                    to="/login"
                    className="text-burgundy-800 hover:text-burgundy-600 transition"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    <LogIn className="w-6 h-6" />
                  </Link>
